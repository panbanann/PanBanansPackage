...
public class NiddhogEntity extends HostileEntity implements IAnimatable {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event)
    {
        ...
        //TODO how to fly, attack, and dash.
    ...
    protected void initGoals() {
        ...
        //this.targetSelector.add(8, new FollowTargetGoal(this, MerchantEntity.class, true));
        //this.targetSelector.add(9, new FollowTargetGoal(this, IronGolemEntity.class, true));
